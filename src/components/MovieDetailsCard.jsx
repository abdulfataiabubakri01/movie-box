...
export const MovieDetailsCardData = [
  {
    id: "details",
...
const MovieDetailsCard = ({
  ...
  return (
    <Link to={`/movieDetails/${id}`}>
      <div
        className=" bg-cover w-screen h-screen bg-center bg-no-repeat md:h-[520px] pl-5 md:pt-5"
        style={{
      ...
      >
        ...
        <div className="flex flex-col md:flex-row text-amber-50  md:max-w-2/3">
          ...
          <div className="md:pl-10">
            <h1 className="text-5xl pb-3 md:pt-15 font-semibold">{header}</h1>
            <p className="text-2xl pl-4 font-semibold">
            ...
            <div className="space-x-3 pt-2">{genreType?.map((genre, index) => (
                                        <span
